              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final otherUserName = conversation['other_user_name'] as String? ?? 'Unknown';
                      final avatarPath = conversation['other_user_avatar'] as String?;
                      final lastMessage = conversation['last_message'] as String? ?? '';
                      final messageTime = conversation['created_at'] as DateTime?;
                      final unreadCount = conversation['unread_count'] as int? ?? 0;
                      final lastMessageSenderId = conversation['last_message_sender_id'] as int?;
                      final lastMessageIsRead = conversation['last_message_is_read'] as int?;
                      ...
                      final isLastMessageFromMe = lastMessageSenderId == _currentUserId;
                      
                      // Determine if message is unread from other user
                      final isUnreadFromOther = !isLastMessageFromMe && lastMessage.isNotEmpty && lastMessageIsRead == 0;
                      ...
                      return Column(
                        children: [
                          if (index == 0 || !_pinnedConversations.contains(_conversations[index - 1]['id'] as int?) && isPinned)
                            Padding(
                          ...
                          GestureDetector(
                                      ...
                                      builder: (context) => Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ListTile(
                                              leading: Icon(
                                                isPinned ? Icons.close : Icons.push_pin,
                            ...
                            child: Container(
                              ...
                              color: unreadCount > 0 ? Colors.grey[100] : Colors.transparent,
                              child: Row(
                                children: [
                                  Stack(
                                    children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                lastMessage.isEmpty ? 'No messages yet' : displayMessage,
                                                style: TextStyle(
                                                  color: lastMessage.isEmpty 
                                                      ? Colors.grey[400]
                                                      : isUnreadFromOther ? Colors.black87 : Colors.grey[600],
                                                  fontSize: 13,
                                                  fontWeight: isUnreadFromOther ? FontWeight.w700 : FontWeight.normal,
